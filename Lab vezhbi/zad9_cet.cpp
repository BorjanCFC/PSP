...
class livche{
    ...
    livche &operator=(const livche &l){
        ...
        lista = new tipuvanje[N];
        for(int i = 0; i < N; i++){
            lista[i].domakjin = l.lista[i].domakjin;
            lista[i].gostin = l.lista[i].gostin;
            lista[i].koeficient = l.lista[i].koeficient;
            lista[i].tip = l.lista[i].tip;
        }
